...
const milestones = [
  { year: '1980', title: 'La Fondazione', description: 'I fratelli Sulpizio aprono il laboratorio a Chieti' },
  { year: '1990', title: 'Primo Ampliamento', description: 'Il laboratorio si espande raggiungendo i 400mq' },
  { year: '2000', title: 'Tradizione e Innovazione', description: 'Introduciamo tecnologie moderne mantenendo l\'anima artigianale' },
  { year: '2020', title: '40 Anni di Attività', description: 'Celebriamo quattro decenni di passione per il legno' },
  { year: 'Oggi', title: '45+ Anni di Esperienza', description: 'Carlo Sulpizio continua la tradizione con la stessa passione' },
];
            ...
            <ScrollReveal animation="slide-left">
              <div>
                ...
                <p className="text-wood-cream/90 text-lg leading-relaxed">
                  Da oltre 45 anni, nel cuore dell'Abruzzo, trasformiamo il legno in opere d'arte 
            ...
            <ScrollReveal animation="fade-up">
              <div className="text-center mb-16">
                ...
                <h2 className="font-heading text-3xl md:text-4xl font-bold text-wood-dark">
                  Tradizione e Innovazione dal 1980
                </h2>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal animation="fade-up" delay={100}>
              <div className="bg-white rounded-2xl p-8 md:p-12 shadow-lg mb-12">
                ...
                <p className="text-wood-dark text-lg leading-relaxed mb-6">
                  La falegnameria <strong>Linea Legno</strong> nasce nel 1980 dalla passione dei
                  <strong> fratelli Giustino, Angelo e Carlo Sulpizio</strong> per la lavorazione del legno. Un mestiere appreso 
                ...
                <p className="text-wood-medium leading-relaxed mb-6">
                  Il nostro laboratorio di oltre <strong>400 mq</strong> sorge a <strong>Chieti</strong>, 
                  nel cuore verde dell'Abruzzo. Da qui, serviamo clienti 
                ...
                <p className="text-wood-medium leading-relaxed">
                  Oggi, dopo oltre 45 anni di attività, Carlo Sulpizio continua la tradizione con la stessa passione 
          ...
          <ScrollReveal animation="fade-up">
            <div className="bg-gradient-to-br from-wood-warm to-wood-medium rounded-3xl p-10 md:p-16 shadow-xl max-w-4xl mx-auto">
              ...
              <p className="text-wood-cream/90 text-lg mb-8">
                Ti aspettiamo nel nostro laboratorio a Chieti per mostrarti come lavoriamo 
