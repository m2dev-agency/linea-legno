...
const contactInfo = [
  {
    icon: MapPin,
    title: 'Indirizzo',
    content: 'Via Francesco Verlengia, 34\n66100 Chieti (CH)',
    link: 'https://maps.google.com/?q=Via+Francesco+Verlengia+34+Chieti+CH',
  },
  {
    icon: Phone,
    title: 'Telefono',
    content: '0871 344584\n378 081 8129',
    link: 'tel:+393780818129',
  },
  {
    icon: Mail,
    title: 'Email',
    content: 'linealegnochieti@virgilio.it',
    link: 'mailto:linealegnochieti@virgilio.it',
  },
  {
    icon: Clock,
    title: 'Orari',
    content: 'Lun - Ven: 08:00 - 12:30, 14:30 - 18:30\nSab - Dom: Chiuso',
    link: null,
  },
];
            ...
            <ScrollReveal animation="slide-right">
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-2xl overflow-hidden shadow-lg">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2948.5!2d14.16!3d42.35!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDLCsDIxJzAwLjAiTiAxNMKwMDknMzYuMCJF!5e0!3m2!1sit!2sit!4v1234567890"
                    width="100%"
                    height="350"
                    style={{ border: 0 }}
                    allowFullScreen
                    ...
                    title="Mappa Linea Legno - Chieti"
                    className="w-full"
                  />
                  <div className="p-6">
                    <h3 className="font-heading text-lg font-semibold text-wood-dark mb-2">
                    ...
                    <p className="text-wood-medium text-sm">
                      Il nostro laboratorio si trova a Chieti, in Via Francesco Verlengia 34. 
                      Facilmente raggiungibile dalla strada statale.
                    </p>
                    <a
                      href="https://maps.google.com/?q=Via+Francesco+Verlengia+34+Chieti+CH"
                      target="_blank"
                ...
                <div className="bg-wood-dark rounded-2xl p-8 text-center">
                  ...
                  <p className="text-wood-cream/80 mb-6">
                    Siamo disponibili dal lunedì al venerdì, dalle 8:00 alle 18:30.
                  </p>
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <a
                      href="tel:+393780818129"
