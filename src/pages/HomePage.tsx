          ...
          <div className="max-w-5xl">
            ...
            >
              <p className="text-xl md:text-2xl text-wood-cream/70 leading-relaxed font-light">
                ...
                realizziamo <span className="text-white font-normal">cucine su misura</span> e 
                produciamo <span className="text-white font-normal">arredi artigianali</span> con 
                oltre 45 anni di passione artigianale.
              </p>
            </div>
            ...
            >
              {[
                { value: '45+', label: 'Anni di Maestria', suffix: '' },
      ...
      <section className="py-16 bg-white">
        <div className="container-custom mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { icon: Clock, value: '45+', label: 'Anni di Esperienza' },
            ...
            <ScrollReveal animation="slide-right">
              <div>
                ...
                <p className="text-wood-medium mb-6 leading-relaxed">
                  La falegnameria <strong>Linea Legno</strong> nasce dalla passione dei fratelli Sulpizio 
                  per la lavorazione del legno. Da oltre 45 anni, nel nostro laboratorio di Chieti, 
                  trasformiamo il legno in opere uniche: cucine su misura che raccontano storie, 
                  arredi che arredano con personalità, porte che uniscono bellezza e funzionalità.
                </p>
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                ...
                >
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-xl font-semibold">378 081 8129</div>
                  </div>
                </a>
              </div>
            </div>
