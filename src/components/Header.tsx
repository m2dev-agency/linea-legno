          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
              ...
              >
                ...
                <span className="text-sm">+39 378 081 8129</span>
              </a>
              <a 
              ...
              >
                ...
                <span className="text-sm">linealegnochieti@virgilio.it</span>
              </a>
            </div>
            ...
            <div className="flex items-center gap-3 text-white/40 text-xs">
              <MapPin size={14} />
              <span>Chieti, Abruzzo — Italia</span>
            </div>
