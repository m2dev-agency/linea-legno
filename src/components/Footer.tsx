          ...
          <div className="lg:col-span-1">
            <Link to="/" className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 bg-gradient-to-br from-accent-gold to-wood-warm rounded-xl flex items-center justify-center">
                <span className="text-wood-dark font-heading text-2xl font-bold">L</span>
              </div>
              <div>
                <h3 className="font-heading text-xl font-bold text-white">Linea Legno</h3>
                <p className="text-sm text-wood-cream/70">dal 1980</p>
              </div>
            </Link>
            <p className="text-wood-cream/80 mb-6 leading-relaxed">
              Oltre 45 anni di passione e maestria artigianale nella lavorazione del legno. 
              Realizziamo cucine su misura, arredi, porte e tavoli con la cura di una volta.
            </p>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-wood-cream/80">
                  Via Francesco Verlengia, 34<br />
                  66100 Chieti (CH)
                </span>
              </li>
              <li>
                <a
                  href="tel:+390871344584"
              ...
              <li>
                <a
                  href="mailto:linealegnochieti@virgilio.it"
                  className="flex items-center gap-3 text-wood-cream/80 hover:text-accent-gold transition-colors"
                >
                  <Mail size={20} className="text-accent-gold flex-shrink-0" />
                  linealegnochieti@virgilio.it
                </a>
              </li>
              <li className="flex items-start gap-3">
      ...
      <div className="border-t border-wood-medium/30">
        <div className="container-custom mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-wood-cream/60">
            <p>
              © {currentYear} Linea Legno dei F.lli Sulpizio & C. S.n.c. - P.IVA 01581440698. Tutti i diritti riservati.
            </p>
